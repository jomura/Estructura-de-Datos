...
public class Ejercicio03 {
    ...
    public void definirArreglo() {
        ...
        try{
            fileReader = new Scanner(new File("datosUnidad1Ejercicio03.txt"));
    ...
    public void defineMenor(){
        float menor =Pago[1];
        int ValMen = 0;
        for (int i=0; i<tipoEmple.length; i++){
            if(Pago[i]<=menor){
                menor = Pago[i];
                ValMen = i;
            }
        }
        System.out.println("El mayor pago es de: " + Nombre[ValMen] + " con: " + Pago[ValMen]);
    }
